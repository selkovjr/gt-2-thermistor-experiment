...
# If measurement columns (m1) were swapped, I could have called this function:
...
#
m3p <- transform(m1[c(1, 20, 38), ], R = R * 1000)  # pick any three data points and convert kΩ to Ω
...
plot1 <- ggplot() +
  ...
  geom_line(data = m1, mapping = aes(x = T, y = model, color='nls fit', linetype = 'nls fit')) +
